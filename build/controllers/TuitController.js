...
class TuitController {
    constructor(app, tuitDao) {
        ...
        this.findTuitById = (req, res) => this.tuitDao.findTuitById(req.params.userid)
            .then(tuits => res.json(tuits));
        ...
        this.createTuit = (req, res) => this.tuitDao.createTuit(req.body)
            .then(tuits => res.json(tuits));
        this.deleteTuit = (req, res) => this.tuitDao.deleteTuit(req.params.userid)
            .then(status => res.json(status));
        this.updateTuit = (req, res) => this.tuitDao.updateTuit(req.params.userid, req.body)
            .then(status => res.json(status));
        this.app = app;
