...
class MessageController {
    constructor() {
         ...
         */
        this.findRecdMessages = (req, res) => MessageController.messageDao.findRecdMessages(req.params.uid).then(messages => res.json(messages));
        /**
         ...
         **/
        this.findSentMessages = (req, res) => MessageController.messageDao.findSentMessages(req.params.uid).then(messages => res.json(messages));
        /**
         ...
         */
        this.userDeletesMessage = (req, res) => MessageController.messageDao.userDeletesMessage(req.params.uid, req.params.uid1).then(status => res.send(status));
        /**
         ...
         * database
         */
        this.userSendsMessage = (req, res) => MessageController.messageDao.userSendsMessage(req.params.uid, req.params.uid1, req.body).then(messages => res.json(messages));
    }
}
